...
class RoutePlannerView(APIView):
    def post(self, request):
        ...
        try:
            ...
            result = route_service.find_optimal_fuel_stops(
                ...
                route_data['geometry'], route_data['distance'], tank_range=300, mpg=10
            )
    ...
    def generate_map(self, coordinates, fuel_stops):
        print(f"Generating map for route with {len(coordinates)} coordinates and {len(fuel_stops)} fuel stops")
